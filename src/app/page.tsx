    ...
    <AnimatedSection>
      <div className='w-full h-screen relative bg-black '>
        ...
        <Image
          ...
          alt='bg'
          fill
          className='object-cover blur-sm absolute inset-0 z-0 ho'
          placeholder='empty'
        />

        <div className="relative z-10 flex justify-center items-center h-full gap-20 ">
           <div className="mr-4 perspective-1000">
      <Image
        src={'/engine.png'}
        height={400}
        width={400}
        ...
        hover:scale-120 duration-500 ease-in-out cursor-pointer
      ...
      />
          ...
          <h1 className='text-5xl text-gray-400 mt-3'><div>
      ...
      <div className='bg-gradient-to-br from-gray-900 via-black to-gray-900 h-30 flex items-center justify-between px-35 '>
        <div>
  ...
  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mx-4 lg:mx-10 gap-4 lg:gap-6 mt-8'>
    {features.map((item, index) => (
      <CardContainer key={index} className="inter-var">
        <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] bg-gradient-to-br from-gray-900 via-black to-gray-900 dark:border-white/[0.2] border-black/[0.1] w-full h-full min-h-[280px] rounded-xl p-6 border flex flex-col">
          ...
          <CardItem
            as="h3"
            translateZ="60"
            className="text-xl font-bold text-neutral-600 dark:text-white text-center mb-3"
          >
            {item.title}
          </CardItem>
          ...
          <CardItem 
            translateZ="100" 
            className="text-neutral-500 text-sm dark:text-neutral-300 text-center flex-1 flex items-start"
          >
            {item.description}
          </CardItem>
